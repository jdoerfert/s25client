...
BOOST_AUTO_TEST_CASE(JoinPlayerAssignment)
{
    ...
    playerInfos.push_back(JoinPlayerInfo(BPI1_4));
    BOOST_REQUIRE(GameServer::assignPlayersOfRandomTeams(playerInfos));
    BOOST_REQUIRE_EQUAL(0, getMaxTeamSizeDifference(playerInfos, 4));
    ...
    playerInfos.push_back(JoinPlayerInfo(BPI1_3));
    BOOST_REQUIRE(GameServer::assignPlayersOfRandomTeams(playerInfos));
    BOOST_REQUIRE_EQUAL(1, getMaxTeamSizeDifference(playerInfos, 3));
    ...
    playerInfos.push_back(JoinPlayerInfo(BPIRT1));
    BOOST_REQUIRE(GameServer::assignPlayersOfRandomTeams(playerInfos));
    BOOST_REQUIRE_EQUAL(0, getMaxTeamSizeDifference(playerInfos, 3));
    ...
    playerInfos.push_back(JoinPlayerInfo(BPIRT1));
    BOOST_REQUIRE(!GameServer::assignPlayersOfRandomTeams(playerInfos));
    BOOST_REQUIRE_EQUAL(2, getMaxTeamSizeDifference(playerInfos, 3));
}
